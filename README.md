...
<details>
<summary><b>Expected RabbitMQ test output</b></summary>
...
**Transport implementation sizes (as of v0.9.5):**
...
- [Release notes](https://github.com/JohnBasrai/mom-rpc/releases/tag/v0.9.5)
